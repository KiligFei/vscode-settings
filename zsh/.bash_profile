...
eval "$(oh-my-posh init bash --config C:\\Users\\WX000010\\AppData\\Local\\Programs\\oh-my-posh\\themes\\sim-web.omp.json)"


#code
alias Github="cd ~/Work/GitHub" # 快速进入github文件夹
...
export PI_DEFAULT=npm
export PI_MaxSockets=8
export PI_SPINNER=dots # loadingstyle
# pi config end
...
export PATH=$PATH:/C:\Users\WX000010\AppData\Local\Programs\Python\Python311\Scripts\
